		...
		<div class="col-6 col-md-4 col-lg-3">
			<a href="<%=ORSView.LOGIN_CTL%>" class="text-decoration-none">
				<div
					...
					<p class="text-muted small mb-0"><%=ms.get("welcome.sign") %></p>
				</div>
			</a>
		</div>
		...
		<div class="col-6 col-md-4 col-lg-3">
			<a href="<%=ORSView.USER_REGISTRATION_CTL%>"
				...
				<div
					...
					<p class="text-muted small mb-0"><%=ms.get("welcome.regcreate") %></p>
				</div>
			</a>
		</div>
		...
		<div class="col-6 col-md-4 col-lg-3">
			<a href="<%=ORSView.GET_MARKSHEET_CTL%>" class="text-decoration-none">
				<div
					...
					<h6 class="fw-bold mb-1"><%=ms.get("welcome.get") %></h6>
