<%@page import="com.sunilos.p4.ctl.EmployeeCtl"%>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.EMPLOYEE_CTL%>" method="POST">
				...
				<div class="mb-3">
					...
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("employeeName", request)%></div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold">Company <span
						class="text-danger">*</span></label> <input type="text" name="company"
						placeholder="Enter Company" class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getCompany())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("company", request)%></div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold">Salary <span
						class="text-danger">*</span></label> <input type="text" name="salary"
						placeholder="Enter Salary" class="form-control" maxlength="200"
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Date Of Birth <span
						class="text-danger">*</span></label> <input type="text" name="dob"
