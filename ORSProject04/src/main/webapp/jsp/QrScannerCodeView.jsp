...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.QrScannerCodeBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit QrScannerCode" : "Add QrScannerCode"%>
			</h5>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.QRSCANNERCODE_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">QrCode <span
						class="text-danger">*</span></label> <input type="text" name="qrcode"
						placeholder="Enter QrCode" class="form-control" maxlength="100"
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">ScannedBy <span
						class="text-danger">*</span></label> <input type="text" name="scannedby"
						placeholder="Enter ScannedBy" class="form-control" maxlength="200"
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">ScanTime<span
						class="text-danger">*</span></label> <input type="text" id="udate"
						readonly="readonly" name="scantime" placeholder="Click Calendar"
						class="form-control" maxlength="200"
						value="<%=DataUtility.getDateString(bean.getScanTime())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("scantime", request)%></div>
				</div>
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="<%=ORSView.QRSCANNERCODE_CTL%>" class="btn btn-danger">
						<i class="bi bi-arrow-clockwise me-1"></i> Reset
					</a> <a href="<%=ORSView.QRSCANNERCODE_LIST_CTL%>"
