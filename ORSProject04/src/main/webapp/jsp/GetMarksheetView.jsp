	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-search me-2"></i> Get Marksheet
			</h5>
		</div>
			...
			<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="POST">
				...
				<div class="input-group">
					...
					<button type="submit" name="operation"
						value="<%=GetMarksheetCtl.OP_GO%>" class="btn btn-primary px-4">
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		<div class="card-header border-0 py-3 px-4 bg-success text-white">
			<h6 class="mb-0 fw-bold">
				<i class="bi bi-file-earmark-check-fill me-2"></i> Marksheet Result
			</h6>
		</div>
			...
			<table class="table table-borderless mb-0">
				<tbody>
					...
					<tr class="border-bottom">
						...
						<td class="py-3"><span
							class="badge bg-primary rounded-pill fs-6 px-3"><%=physics%></span>
						</td>
					</tr>
					<tr class="border-bottom">
						<th class="ps-4 py-3 text-muted">Chemistry</th>
						<td class="py-3"><span
							class="badge bg-success rounded-pill fs-6 px-3"><%=chemistry%></span>
						</td>
					</tr>
					<tr class="border-bottom">
						<th class="ps-4 py-3 text-muted">Maths</th>
						<td class="py-3"><span
							class="badge bg-warning text-dark rounded-pill fs-6 px-3"><%=maths%></span>
						</td>
					</tr>
					<tr class="border-bottom table-light">
						<th class="ps-4 py-3">Total <small
							class="text-muted fw-normal">(out of 300)</small></th>
						<td class="py-3"><span
							class="badge bg-dark rounded-pill fs-6 px-3"><%=total%></span></td>
					</tr>
					<tr class="table-light">
						<th class="ps-4 py-3">Percentage</th>
						<td class="py-3"><span
							class="badge bg-info text-dark rounded-pill fs-6 px-3"><%=String.format("%.2f", percentage)%>
								%</span></td>
					</tr>
				</tbody>
			</table>
