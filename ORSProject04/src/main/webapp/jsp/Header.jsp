			...
			<ul class="navbar-nav me-auto gap-0">
					...
					<ul
						...
						<li>
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-search me-1"></i> <%=ms.get("header.query") %>
							</h6>
						</li>
						...
						<li>
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-gear me-1"></i> <%=ms.get("header.mang") %>
							</h6>
						</li>
						<li><a class="dropdown-item"
				...
				<li class="nav-item dropdown"><a
					...
					<ul
						...
						<li>
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-person-workspace me-1"></i> InterView
							</h6>
						</li>
						<li><a class="dropdown-item"
							href="<%=ORSView.INTERVIEW_CTL%>"> <i
								class="bi bi-person-workspace me-2 text-success"></i> Add
								InterView
						</a></li>
						<li><a class="dropdown-item"
							href="<%=ORSView.INTERVIEW_LIST_CTL%>"> <i
								class="bi bi-clipboard2-check me-2 text-primary"></i> InterView
								List
						</a></li>
					</ul></li>
					...
					<ul
						...
						<li>
							<h6 class="dropdown-header text-uppercase text-warning small">
								<i class="bi bi-mortarboard me-1"></i> <%=ms.get("hader.acd") %>
							</h6>
						</li>
						<li><a class="dropdown-item"
				...
				<li class="nav-item dropdown"><a
					...
					<ul
						...
						<li>
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-person-fill me-1"></i> Employeee
							</h6>
						</li>
						...
						<li>
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-building-fill me-1"></i> PgHostel
							</h6>
						</li>
						...
						<li>
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-key-fill me-1"></i> SoftwareLicense
							</h6>
						</li>
