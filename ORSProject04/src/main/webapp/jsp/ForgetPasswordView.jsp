...
<div class="container py-5" style="max-width: 520px;">
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-4 px-4 text-center"
			...
			<p class="mb-0 opacity-75 small">Enter your email and we'll send
				your password.</p>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.FORGET_PASSWORD_CTL%>" method="POST">
				...
				<div class="mb-4">
					<label class="form-label fw-semibold">Email / Login ID <span
				...
				<div class="text-center mt-3">
					<a href="<%=ORSView.LOGIN_CTL%>"
						...
						class="bi bi-arrow-left me-1"></i> Back to Login
					</a>
				</div>
			</form>
		</div>
