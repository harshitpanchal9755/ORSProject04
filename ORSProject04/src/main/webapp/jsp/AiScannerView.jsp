...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.AiScannerBean"
	...
	0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit AiScanner" : "Add AiScanner"%>
			</h5>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.AISCANNER_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">AiScannerName <span
						class="text-danger">*</span></label> <input type="text" name="aiscannerName" placeholder="Enter AiScannerName"
						class="form-control" maxlength="100"
						value="<%=DataUtility.getStringData(bean.getAiscannerName())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("aiscannerName", request)%></div>
				</div>
				
				<div class="mb-3">
					<label class="form-label fw-semibold">Type<span
						class="text-danger">*</span></label> <input type="text"
						name="type"  placeholder="Enter Type" class="form-control" maxlength="200"
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Description<span
						class="text-danger">*</span></label> <input type="text" name="description"  placeholder="Enter Description"
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="<%=ORSView.AISCANNER_CTL%>" class="btn btn-danger">
						<i class="bi bi-arrow-clockwise me-1"></i> Reset
					</a> <a href="<%=ORSView.AISCANNER_LIST_CTL%>"
