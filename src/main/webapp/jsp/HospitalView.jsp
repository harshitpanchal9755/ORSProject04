	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit Hospital" : "Add Hospital"%>
			</h5>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.HOSPITAL_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">PatientName <span
						class="text-danger">*</span></label> <input type="text" name="patientName"
						placeholder="Enter PatientName" class="form-control"
						maxlength="100"
						value="<%=DataUtility.getStringData(bean.getPatientName())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("patientName", request)%></div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold">Disease <span
						class="text-danger">*</span></label> <input type="text" name="disease"
						placeholder="Enter Disease" class="form-control" maxlength="200"
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">DoctorName <span
						class="text-danger">*</span></label> <input type="text" name="doctorName"
						placeholder="Enter DoctorName" class="form-control"
						maxlength="200"
						value="<%=DataUtility.getStringData(bean.getDoctorName())%>">

					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("doctorName", request)%></div>
				</div>
				...
				<div class="mb-4">
					...
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("admissionDate", request)%></div>
				</div>
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="<%=ORSView.HOSPITAL_CTL%>" class="btn btn-danger me-1">
						<i class="bi bi-arrow-clockwise"></i> Reset
					</a> <a href="<%=ORSView.HOSPITAL_LIST_CTL%>"
